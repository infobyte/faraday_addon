...
function getRequestAndResponseBody(e) {
 if(tabId == e.tabId && getDomainByUrl(e.url).match(target) != null && power || (ifserver && getDomainByUrl(e.url) == getDomainByUrl(faraday_server))){ // Verifico que el tabId dle request sea igual al tabId de donde estamos parados
...
function getResquestHeaders(e){
	if(tabId == e.tabId && getDomainByUrl(e.url).match(target) != null && power || (ifserver && getDomainByUrl(e.url) == getDomainByUrl(faraday_server))){ // Verifico que el tabId del request sea igual al tabId de donde estamos parados
